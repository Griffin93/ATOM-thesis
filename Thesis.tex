...
% \input{Tex/Listoffigures}% list of symbols
% \input{Tex/Listoftables}% list of abbr
{% content list region
\noindent
...
\input{Tex/Listofsymbol}% list of symbols
\input{Tex/Listofabbr}% list of abbr
}
{% content list region
\noindent
\linespread{1.2}% local line space
...
\input{Tex/Acknowledgement}% Acknowledgement
\input{Tex/Achievement}% Achievement
\end{document}
%---------------------------------------------------------------------------%
